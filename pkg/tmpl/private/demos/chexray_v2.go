			...
			<div class="settings-container">
				<div class="mdl-card mdl-shadow--4dp">
					...
					<div class="mdl-card__supporting-text chexray-settings-ctx">
						...
						<div class="mdl-textfield mdl-js-textfield getmdl-select" style="">
							<input class="mdl-textfield__input" value="" id="model-cam" readonly/>
							<input value="" type="hidden" name="model-cam-engine"/>
							<label class="mdl-textfield__label" for="model">Cam base model</label>
							<ul class="mdl-menu mdl-menu--bottom-left mdl-js-menu" for="model-cam">
								<li class="mdl-menu__item" data-val="mobilenet-v2">MobileNet V2</li>
								<li class="mdl-menu__item" data-val="inception-resnet-v2" disabled>DenseNet 121</li>
								<li class="mdl-menu__item" data-val="inception-resnet-v2" disabled>DenseNet 169</li>
								<li class="mdl-menu__item" data-val="inception-resnet-v2" disabled>DenseNet 201</li>
							</ul>
						</div>
